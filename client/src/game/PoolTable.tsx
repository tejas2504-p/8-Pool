...
// Reused Geometries
const feltBedGeometry = new THREE.BoxGeometry(14.4, 0.2, 7.2);
const cornerPocketGeometry = new THREE.CylinderGeometry(0.312, 0.312, 0.1, 24);
const middlePocketGeometry = new THREE.CylinderGeometry(0.288, 0.288, 0.1, 24);

const horizontalRailGeometry = new THREE.BoxGeometry(15.552, 0.4, 0.4);
const verticalRailGeometry = new THREE.BoxGeometry(0.4, 0.4, 8.16);
const tableLegGeometry = new THREE.BoxGeometry(0.5, 3.0, 0.5);

// New Rims & Cushion Geometries
const cornerRimGeometry = new THREE.RingGeometry(0.30, 0.348, 32);
const middleRimGeometry = new THREE.RingGeometry(0.276, 0.324, 32);

const horizontalCushionGeometry = new THREE.BoxGeometry(5.904, 0.2, 0.06);
const verticalCushionGeometry = new THREE.BoxGeometry(0.06, 0.2, 5.52);
